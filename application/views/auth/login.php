...
<style>
body { 
        background-image: url("https://itkoding.com/wp-content/uploads/2023/07/background-hitam-aesthetic.jpg"); 
    }
    </style>
...
<body class="flex min-h-screen justify-center items-center bg-black/50">
    <div class="flex flex-col w-1/3 p-6 h-1/2 rounded-md sm:p-10  dark:text-gray-100">
        <div class="mb-8 text-center">
            <h1 class="my-3 text-4xl font-bold" style="color:white"> Login</h1>
        ...
        <form action="<?php echo base_url(); ?>auth/process_login" method="post" class="space-y-12">
            <div class="space-y-4">
                <div>
                    ...
                    <label for="email" class="block mb-2 text-sm" style="color:white">Email </label>
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        <label for="password" class="text-sm" style="color:white">Password</label>
            ...
            <div class="space-y-2">
                ...
                <p class="px-6 text-sm text-center dark:text-gray-400">
                    <a rel="noopener noreferrer" href="<?php echo base_url('auth/register'); ?>" class="hover:underline dark:text-violet-400" style="color:white">DAFTAR DISINI!!!</a>.
                </p>
            </div>
        </form>
    </div>
